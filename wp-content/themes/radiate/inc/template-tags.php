...
function radiate_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<div class="nav-links">
			...
			<div class="nav-previous"><?php previous_post_link( '%link', _x( '&laquo; %title', 'Previous post link', 'radiate' ) ); ?></div>
			<div class="nav-next"><?php next_post_link( '%link', _x( '%title &raquo;', 'Next post link', 'radiate' ) ); ?></div>
...
function radiate_posted_on() {
	...
	printf( '<span class="posted-on">%1$s</span><span class="byline">%2$s</span>',
		...
		sprintf( '<span class="author vcard"><a itemprop="author" class="url fn n" href="%1$s">%2$s</a></span>',
